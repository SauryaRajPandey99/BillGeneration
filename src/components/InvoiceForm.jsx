  ...
  const deleteItemHandler = (id) => {
    setItems((prevItems) => {
      ...
      if (prevItems.length === 1) {
        setToastMessage("Cannot delete the last item."); // Show toast message
        setTimeout(() => setToastMessage(""), 3000); // Hide after 3 seconds
        return prevItems; // Return the previous items without changes
      }
      // Proceed with deletion if there are multiple items
        ...
        <div className="my-6 flex-1 space-y-2  rounded-md bg-white p-4 shadow-sm sm:space-y-4 md:p-6">
          ...
          <div className="grid grid-cols-2 gap-2 pt-4 pb-8">
            ...
            >
              ...
              <option value="Saurya">Saurya</option>
              <option value="Nikit">Nikit</option>
